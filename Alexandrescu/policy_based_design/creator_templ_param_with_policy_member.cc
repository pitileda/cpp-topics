...
// forward declaration of host class
// to make it friend in base class
...
class PrototypeCreator {
 ...
 protected:
  ...
  friend class WidgetManager<PrototypeCreator>;
};
...
// but this time with member that is Creator
// to make default constructed object
// WidgetManager<PrototypeCreator> wm;
// we need to add our instation of temaplate
// in Policy base class as a friend
template <template <typename> class Creator>
class WidgetManager : public Creator<Widget> {
 private:
  std::vector<Widget*> widgets_;
  Creator<Widget> creator_;
 ...
 public:
  ...
  bool add() {
    ...
    widgets_.push_back(creator_.create());
